...
images.forEach((images, imageIndex)=>{
...
function conditionalRenderingOfReservationPanel(adventure) {
  ...
  document.getElementById("reservation-person-cost").innerHTML= adventure.costPerHead
    ...
    let parentNode = document.getElementById("reservation-panel-available");
   parentNode.style.display="none"
   let parentNode2 = document.getElementById("reservation-panel-sold-out");
   parentNode2.style.display="block"
...
form.addEventListener("submit",async (e)=>{
  ...
  try{
    ...
    if(res.ok){
      ...
      alert(`Failed - fetch ${data.message}`)
    }
